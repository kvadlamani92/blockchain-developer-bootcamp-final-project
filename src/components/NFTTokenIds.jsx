...
function NFTTokenIds({ inputValue, setInputValue }) {
  console.log('NFTTOkenIds: inputValue', inputValue);
  const fallbackImg =
  ...
  async function purchase() {
    ...
    const ops = {
      ...
      abi: contractABI,
      params: {
        _nftContract: nftToBuy.token_address,
        _itemId: itemID,
      },
      msgValue: tokenPrice,
    };
  ...
  const getMarketItem = (nft) => {
    console.log('in get marketItem:',nft);
  ...
  return (
    <>
      <div>
        {(contractABI === null || contractABI === undefined) && (
          <>
            <Alert
