...
import { FileSearchOutlined, ShoppingCartOutlined, CoffeeOutlined } from "@ant-design/icons";
...
function NFTBalance() {
  ...
  const { walletAddress, chainId, marketAddress, contractABI, tokenAddress, tokenABI } = useMoralisDapp();
  ...
  console.log('NFTBalance:', NFTBalance,'fetchSuccess:',fetchSuccess);

  console.log('nft contract address:',tokenAddress);
  console.log('nft contract abi:',tokenABI);

  async function burn(tokenId) {
    if(tokenId === "" || tokenId === undefined){
        console.log('nft is not valid. Skipping');
        return;
    }
  ...
  function succBurn() {
    ...
    const modal = Modal.success({
      title: "Success!",
      content: `Your NFT is successfully burned!`,
    });
    setTimeout(() => {
      modal.destroy();
    }, secondsToGo * 1000);
  ...
  function failBurn() {
    ...
    const modal = Modal.error({
      title: "Error!",
      content: `There was a problem in burning your NFT. Please try again after sometime.`,
    });
    setTimeout(() => {
      modal.destroy();
    }, secondsToGo * 1000);
  ...
  async function list(nft, listPrice) {
    ...
    const ops = {
      ...
      abi: contractABI,
      params: {
        _nftContract: nft.token_address,
          ...
          NFTBalance.map((nft, index) => (
            <Card
              ...
              actions={[
                ...
                <Tooltip title="Burn NFT">
                  <CoffeeOutlined onClick={() => burn(nft.token_id)} />
                </Tooltip>,
              ]}
